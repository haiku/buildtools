...
/* /usr/ccs doesn't exist on BeOS, so we don't want to use it */
...
// [zooey]: later versions of BeOS do not use -lnet (as it doesn't exist),
// and I think it doesn't make sense anyway...
...
/* [zooey]:
   ...
   So we ignore '#pragma interface' for BeOS.
