...
public:
  ...
  inline isl::checked::map extract_map(isl::checked::space dim) const;
...
public:
  ...
  inline isl::checked::set extract_set(isl::checked::space dim) const;
  inline stat foreach_point(const std::function<stat(isl::checked::point)> &fn) const;
...
isl::checked::map union_map::extract_map(isl::checked::space dim) const
{
...
isl::checked::set union_set::extract_set(isl::checked::space dim) const
{
